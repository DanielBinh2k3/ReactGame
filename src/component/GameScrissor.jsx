...
function GameScrissor({ onNextPhase }) {
  ...
  const handleGameComplete = () => {
    // Perform game-related actions or cleanup
    setGameOver(true);
    onNextPhase(); // Call the function to proceed to the next phase
  };
